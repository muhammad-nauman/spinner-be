...
<div class="row">
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $productsCount }}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $machinesCount }}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $inventoriesTotalToday }}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{$productsAvailableForToday}}</h1>
                <div class="stat-percent font-bold text-navy"> <i class="fa fa-level-up"></i></div>
                <small>Available</small>
            </div>
        </div>
...
<div class="footer">
    <div>
        <strong>Copyright</strong> Wheel Spinner Game &copy; {{ now()->year }}
    </div>
</div>
</div>
